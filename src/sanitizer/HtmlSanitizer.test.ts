...
describe('HtmlSanitizer', () => {
    ...
    describe('clean()', () => {
        ...
        describe('Input validation', () => {
            it('should return empty string for null input', () => {
                const result = HtmlSanitizer.clean(null as unknown, ['p']);
                expect(result).toBe('');
            });

            it('should return empty string for undefined input', () => {
                const result = HtmlSanitizer.clean(undefined as unknown, ['p']);
                expect(result).toBe('');
            });

            it('should return empty string for non-string input', () => {
                const result = HtmlSanitizer.clean(123 as unknown, ['p']);
                expect(result).toBe('');
            });
            ...
            it('should strip all tags if allowedTags is not an array', () => {
                const html = '<p>Text</p>';
                const result = HtmlSanitizer.clean(html, 'p' as unknown);
            ...
            it('should filter out invalid tag names', () => {
                ...
                const result = HtmlSanitizer.clean(html, ['p', '123invalid', '', null as unknown]);
    ...
    describe('stripAllTags()', () => {
        ...
        it('should handle empty input', () => {
            ...
            expect(HtmlSanitizer.stripAllTags(null as unknown)).toBe('');
            expect(HtmlSanitizer.stripAllTags(undefined as unknown)).toBe('');
        });
    });
    ...
    describe('sanitizeForAttribute()', () => {
        ...
        it('should handle empty strings', () => {
            ...
            expect(HtmlSanitizer.sanitizeForAttribute(null as unknown)).toBe('');
        });
    });
    ...
    describe('sanitizeForHtml()', () => {
        ...
        it('should handle empty input', () => {
            ...
            expect(HtmlSanitizer.sanitizeForHtml(null as unknown)).toBe('');
        });
    });
    ...
    describe('isValidUrl()', () => {
        ...
        describe('Invalid input', () => {
            ...
            it('should reject null/undefined', () => {
                expect(HtmlSanitizer.isValidUrl(null as unknown)).toBe(false);
                expect(HtmlSanitizer.isValidUrl(undefined as unknown)).toBe(false);
            });
    ...
    describe('isValidEmail()', () => {
        ...
        describe('Invalid emails', () => {
            ...
            it('should reject null/undefined', () => {
                expect(HtmlSanitizer.isValidEmail(null as unknown)).toBe(false);
                expect(HtmlSanitizer.isValidEmail(undefined as unknown)).toBe(false);
            });
    ...
    describe('decodeHtmlEntities()', () => {
        ...
        it('should handle empty input', () => {
            ...
            expect(HtmlSanitizer.decodeHtmlEntities(null as unknown)).toBe('');
        });
    });
    ...
    describe('replaceTagAttributes()', () => {
        ...
        it('should return empty for null html', () => {
            const result = HtmlSanitizer.replaceTagAttributes(null as unknown, 'a', { target: '_blank' });
            expect(result).toBe('');
        });

        it('should return html unchanged for null tagName', () => {
            const html = '<a href="/link">Click</a>';
            const result = HtmlSanitizer.replaceTagAttributes(html, null as unknown, { target: '_blank' });
