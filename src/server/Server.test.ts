...
describe('Server', () => {
    ...
    describe('Constructor', () => {
        ...
        it('should log success message when server starts', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('✓ HTTP Server listening on 0.0.0.0:3000');
        ...
        it('should handle EADDRINUSE error', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('✗ Port 3000 is already in use');
        ...
        it('should handle generic errors', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('✗ HTTP Server error:', expect.any(Error));
            expect(exitSpy).toHaveBeenCalledWith(1);
    ...
    describe('close', () => {
        ...
        it('should handle close errors', async () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('✗ Error closing HTTP Server:', expect.any(Error));
